...
class SafetyFilter:
    def __init__(self, custom_banned_words: List[str] = None):
        self.banned_words = BANNED_WORDS_PASHTO + BANNED_WORDS_ENGLISH + (custom_banned_words or [])
...
def filter_conversation(messages: List[Dict[str, str]], safety_filter: SafetyFilter = None) -> List[Dict[str, str]]:
