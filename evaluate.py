...
def main():
    ...
    # Field mapping
    parser.add_argument("--source_field", default="instruction",
                       help="Field name for input/source text")
    parser.add_argument("--reference_field", default="output",
                       help="Field name for reference/target text")
