...
from evaluation.metrics import compute_all_metrics, compute_bleu, compute_chrf
...
class TestCleanPashto(unittest.TestCase):
    ...
    def test_partial_match(self):
        ...
        self.assertGreater(bleu_result["bleu"], 60.0)
        self.assertLess(bleu_result["bleu"], 100.0)
        self.assertGreater(chrf_result["chrf"], 70.0)
