...
def main():
    ...
    parser.add_argument("--use_chat_format", action="store_true", default=True,
                       help="Use chat format for prompts")
    parser.add_argument("--no_chat_format", action="store_true",
                       help="Disable chat format")
